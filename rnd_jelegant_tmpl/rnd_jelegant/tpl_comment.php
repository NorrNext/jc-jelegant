...
<?php
				...
				// End Avatar
?>
	<a class="comment-anchor" href="<?php echo $thisurl; ?>#comment-<?php echo $comment->id; ?>" id="comment-<?php echo $comment->id; ?>">Permalink<?php echo $comment_number; ?></a>
<?php
				// Begin Vote
...
?>
<br><a class="comment-email" href="mailto:<?php echo $comment->email; ?>"><?php echo $comment->email; ?></a>
<?php
				}
?>
